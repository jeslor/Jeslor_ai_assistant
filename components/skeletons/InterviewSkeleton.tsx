...
const InterviewSkeleton = ({ totalCards }: any) => {
  return Array.from({ length: totalCards }, (_, index) => (
    <div className="animate-pulse bg-white/10 backdrop-blur-md rounded-3xl p-4 shadow-xl border border-dark1/10 w-full">
      ...
      <div className="h-5 bg-gray-300/30 rounded mb-2 w-3/4" />
      <div className="h-4 bg-gray-300/20 rounded mb-2 w-1/3" />
      <div className="h-3 bg-gray-300/20 rounded mb-2 w-2/3" />
      <div className="flex flex-col gap-2 py-3">
        <div className="h-4 bg-gray-300/20 rounded w-1/2" />
        <div className="h-4 bg-gray-300/20 rounded w-1/3" />
      </div>
      <div className="h-7 bg-gray-300/10 rounded mb-6 w-full" />
      <div className="h-4 bg-gray-300/20 rounded mb-2 w-full" />
      <div className="h-4 bg-gray-300/20 rounded mb-2 w-11/12" />
      <div className="h-4 bg-gray-300/20 rounded mb-6 w-3/4" />
